...
Tabs.Main:AddButton({
    ...
    Description = "",
    Callback = function()
if game.Players.LocalPlayer.Character.CFrame ~= CFrame(3259.35181, -74.5, 821.916199, 0.00376401632, -5.12010487e-08, 0.999992907, 2.30775996e-10, 1, 5.12005442e-08, -0.999992907, 3.80546705e-11, 0.00376401632) then
...
local slappinger = Tabs.Main:AddToggle("TheSlappingToggle", {
    ...
    Callback = function(state)
        ...
        if slapping then
            task.spawn(function()
                while slapping do
game:GetService("VirtualInputManager"):SendMouseButtonEvent(1000, 1000, Enum.UserInputType.MouseButton1, true, 0)
task.wait(0.005)
game:GetService("VirtualInputManager"):SendMouseButtonEvent(1000, 1000, Enum.UserInputType.MouseButton1, false, 0)
